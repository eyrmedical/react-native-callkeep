...
import static com.eyr.callkeep.Constants.EXTRA_CALL_NUMBER_SCHEMA;
import static com.eyr.callkeep.Constants.EXTRA_CALL_UUID;
import static com.eyr.callkeep.Constants.EXTRA_DISABLE_ADD_CALL;
import static com.eyr.callkeep.Constants.FOREGROUND_SERVICE_TYPE_MICROPHONE;
...
public class VoiceConnectionService extends ConnectionService {
  ...
  private void wakeUpApplication(String uuid, String number, String displayName) {
    ...
    Intent headlessIntent = new Intent(
      ...
      EyrCallBannerDisplayService.class
    );

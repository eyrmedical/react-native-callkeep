...
import static com.eyr.callkeep.Constants.ACTION_ANSWER_CALL;
import static com.eyr.callkeep.Constants.ACTION_AUDIO_SESSION;
import static com.eyr.callkeep.Constants.ACTION_CHECK_REACHABILITY;
import static com.eyr.callkeep.Constants.ACTION_DTMF_TONE;
import static com.eyr.callkeep.Constants.ACTION_END_CALL;
import static com.eyr.callkeep.Constants.ACTION_HOLD_CALL;
import static com.eyr.callkeep.Constants.ACTION_MUTE_CALL;
import static com.eyr.callkeep.Constants.ACTION_ONGOING_CALL;
import static com.eyr.callkeep.Constants.ACTION_ON_SILENCE_INCOMING_CALL;
import static com.eyr.callkeep.Constants.ACTION_SHOW_INCOMING_CALL_UI;
import static com.eyr.callkeep.Constants.ACTION_UNHOLD_CALL;
import static com.eyr.callkeep.Constants.ACTION_UNMUTE_CALL;
import static com.eyr.callkeep.Constants.ACTION_WAKE_APP;
import static com.eyr.callkeep.Constants.EXTRA_CALLER_NAME;
import static com.eyr.callkeep.Constants.EXTRA_CALL_NUMBER;
import static com.eyr.callkeep.Constants.EXTRA_CALL_UUID;
...
public class EyrCallBannerControllerModule extends ReactContextBaseJavaModule {
  ...
  public static EyrCallBannerControllerModule instance = null;
  ...
  public static EyrCallBannerControllerModule getInstance(ReactApplicationContext reactContext, boolean realContext) {
    if (instance == null) {
      instance = new EyrCallBannerControllerModule(reactContext);
    }
    if (realContext) {
  ...
  public void startObserving() {
    ...
    if (count > 0) {
      this.reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class).emit("RNCallKeepDidLoadWithEvents", delayedEvents);
      delayedEvents = new WritableNativeArray();
    }
  }
      ...
      getReactApplicationContext()
        ...
        .requestMultiplePermissions(allPermissionaw, new Promise() {
          ...
          public void resolve(@Nullable Object value) {
            ...
            EyrCallBannerControllerModule.onRequestPermissionsResult(REQUEST_READ_PHONE_STATE, allPermissions, grantedResult);
          }
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      switch (intent.getAction()) {
        ...
        case ACTION_WAKE_APP:
          Intent headlessIntent = new Intent(reactContext, EyrCallBannerDisplayService.class);
